  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          backgroundImage: 'url(/Assets/IMG/filieres/school.jpg)',
      ...
      <div className="container position-relative z-2">
        ...
        >
          <div className="col-lg-8 text-center mx-auto">
            ...
            >
              Excellence académique et technique à Kara. Le CETMB propose des parcours rigoureux conçus pour former l'élite technique de demain.
            </motion.p>
          </div>
        </motion.div>
      </div>
